...
import 'package:e_services/pages/SignUp_LoginPage/pages/ServiceProvider/Session_widgets/signup_sp.dart';
                                  ...
                                  if (controller.state.signUpNameController.text.isNotEmpty &&
                                    ...
                                    ProviderModel provider = ProviderModel(
                                      providerName: controller
                                          .state.signUpNameController.text
                                          .trim()
                                          .toString(),
                                      phone: controller
                                    ...
                                    // print(provider.providerName.toString());
                                    // print("inside login code");
